...
/**
 * our_print_error - prints an error message
...
/**
 * our_print_d - function prints a decimal (integer) number (base 10)
 * @input: the input
...
/**
 * our_convert_number - converter function, a clone of itoa
 * @num: number
 * @base: base
...
/**
 * our_remove_comments - function replaces first instance of '#' with '\0'
