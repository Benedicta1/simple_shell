...
/**
 * our_myenv - prints the current environment
...
/**
 * our_getenv - gets the value of an environ variable
 * @info: Structure containing potential arguments. Used to maintain
 * @name: env var name
 *
 * Return: the value
...
/**
 * our_mysetenv - Initialize a new environment variable,
...
/**
 * our_myunsetenv - Remove an environment variable
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 * Return: Always 0
 */
int our_myunsetenv(info_t *info)
{
	...
	for (i = 1; i <= info->argc; i++)
		our_unsetenv(info, info->argv[i]);

	return (0);
}

/**
 * our_populate_env_list - populates env linked list
 * @info: Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 * Return: Always 0
 */
